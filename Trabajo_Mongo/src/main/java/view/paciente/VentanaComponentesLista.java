...
public class VentanaComponentesLista extends JFrame {
	...
	public VentanaComponentesLista() {
		...
		btnCancelar.setBounds(120, 262, 103, 34);
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Boolean anadido = controllerInterfaz.anadirComponente(dni, atributoPrincipal, atributoLista,
						listaDeListas);
				if (anadido == true) {
		...
		btnAceptar.setBounds(290, 262, 103, 34);
		...
		lblMensaje.setBounds(46, 306, 430, 29);
