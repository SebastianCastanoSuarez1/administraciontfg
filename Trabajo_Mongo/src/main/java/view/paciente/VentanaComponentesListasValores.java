...
public class VentanaComponentesListasValores extends JFrame {
	...
	private VentanaAnadirComponente vac;
	private JTextField textFieldAtributoPrincipal;
	private JLabel lblAtributoPrincipal;
	private JTextArea textAreaListaValores;
	private JLabel lblListaValores;
	...
	public VentanaComponentesListasValores() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Boolean anadido = controllerInterfaz.anadirComponente(dni, atributoPrincipal, atributos, listaValores,
						listaAtributos, listaDeListas);
				if (anadido == true) {
